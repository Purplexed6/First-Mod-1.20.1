...
public class ColossitePickaxeItem extends PickaxeItem {

    public ColossitePickaxeItem(Tier tier, int attackDamage, float attackSpeed, Item.Properties properties) {
