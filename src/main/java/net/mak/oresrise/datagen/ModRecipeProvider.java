    ...
    protected void buildRecipes(Consumer<FinishedRecipe> pWriter) {
      ...
      /*  ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.JADE_BLOCK.get())
       ...
       /* ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.RAW_COBALT_BLOCK.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, DreadsteelSet.DREADSTEEL_HELMET.get())
                .pattern("SSS")
                .pattern("S S")
                .define('S', DreadsteelSet.DREADSTEEL_INGOT.get())
                .unlockedBy(getHasName(DreadsteelSet.DREADSTEEL_INGOT.get()), has(DreadsteelSet.DREADSTEEL_INGOT.get()))
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, DreadsteelSet.DREADSTEEL_CHESTPLATE.get())
                .pattern("S S")
                .pattern("SSS")
                .pattern("SSS")
                .define('S', DreadsteelSet.DREADSTEEL_INGOT.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, DreadsteelSet.DREADSTEEL_LEGGINGS.get())
                .pattern("SSS")
                .pattern("S S")
                .pattern("S S")
                .define('S', DreadsteelSet.DREADSTEEL_INGOT.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, DreadsteelSet.DREADSTEEL_BOOTS.get())
                .pattern("S S")
                .pattern("S S")
                .define('S', DreadsteelSet.DREADSTEEL_INGOT.get())
                .unlockedBy(getHasName(DreadsteelSet.DREADSTEEL_INGOT.get()), has(DreadsteelSet.DREADSTEEL_INGOT.get()))
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, DreadsteelSet.DREADSTEEL_PICKAXE.get())
                .pattern("SSS")  
                .pattern(" # ")
                .pattern(" # ") 
                .define('S', DreadsteelSet.DREADSTEEL_INGOT.get())  
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, DreadsteelSet.DREADSTEEL_SWORD.get())
                .pattern(" S ")  
                .pattern(" S ")
                .pattern(" # ") 
                .define('S', DreadsteelSet.DREADSTEEL_INGOT.get())  
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, DreadsteelSet.DREADSTEEL_AXE.get())
                .pattern("SS ")  
                .pattern("S# ")
                .pattern(" # ") 
                .define('S', DreadsteelSet.DREADSTEEL_INGOT.get())  
                .define('#', Misc.OBSIDIAN_STICK.get())
                .unlockedBy(getHasName(DreadsteelSet.DREADSTEEL_INGOT.get()), has(DreadsteelSet.DREADSTEEL_INGOT.get()))
                .save(pWriter, ExampleMod.MOD_ID + ":dreadsteel_axe_1");
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, DreadsteelSet.DREADSTEEL_AXE.get())
                ...
                .define('#', Misc.OBSIDIAN_STICK.get())
                .unlockedBy(getHasName(DreadsteelSet.DREADSTEEL_INGOT.get()), has(DreadsteelSet.DREADSTEEL_INGOT.get()))
                .save(pWriter, ExampleMod.MOD_ID + ":dreadsteel_axe_2");

        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, DreadsteelSet.DREADSTEEL_SHOVEL.get())
                .pattern(" S ")  
                .pattern(" # ")
                .pattern(" # ") 
                .define('S', DreadsteelSet.DREADSTEEL_INGOT.get())  
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, DreadsteelSet.DREADSTEEL_HOE.get())
                .pattern("SS ")  
                .pattern(" # ")
                .pattern(" # ") 
                .define('S', DreadsteelSet.DREADSTEEL_INGOT.get())  
                .define('#', Misc.OBSIDIAN_STICK.get())
                .unlockedBy(getHasName(DreadsteelSet.DREADSTEEL_INGOT.get()), has(DreadsteelSet.DREADSTEEL_INGOT.get()))
                .save(pWriter, ExampleMod.MOD_ID + ":dreadsteel_hoe_1");
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, DreadsteelSet.DREADSTEEL_HOE.get())
                ...
                .define('#', Misc.OBSIDIAN_STICK.get())
                .unlockedBy(getHasName(DreadsteelSet.DREADSTEEL_INGOT.get()), has(DreadsteelSet.DREADSTEEL_INGOT.get()))
                .save(pWriter, ExampleMod.MOD_ID + ":dreadsteel_hoe_2");
       ...
       /* ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, QuintessiteSet.QUINTESSITE_HELMET.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, DreadsteelSet.DREADSTEEL_UPGRADE_SMITHING_TEMPLATE.get(), 2)
                ...
                .save(pWriter, new ResourceLocation(ExampleMod.MOD_ID, "dreadsteel_upgrade_template_duplication")); // Use pWriter here
