...
public class WailingOreBlock extends DropExperienceBlock {

    public WailingOreBlock(Properties properties, IntProvider xpRange) {
    ...
    public void animateTick(BlockState state, Level level, BlockPos pos, RandomSource random) {
        ...
        level.addParticle(
                new DustParticleOptions(new Vector3f(0.812f, 1.0f, 0.992f), 1.0f),
                x, y, z,
                0.0D, 0.0D, 0.0D
        );
    }
