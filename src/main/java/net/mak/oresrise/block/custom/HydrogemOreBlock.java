...
public class HydrogemOreBlock extends DropExperienceBlock {

    public HydrogemOreBlock(Properties properties, IntProvider xpRange) {
    ...
    public void animateTick(BlockState state, Level level, BlockPos pos, RandomSource random) {
        ...
        level.addParticle(
                new DustParticleOptions(new Vector3f(0.0f, 0.2f, 1.0f), 1.0f),
                x, y, z,
                0.0D, 0.02D, 0.0D
        );
    }
